<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:73:"F:\etereauty\public/../application/admin\view\users\admin_permission.html";i:1534928284;s:52:"F:\etereauty\application\admin\view\public\left.html";i:1543904915;s:54:"F:\etereauty\application\admin\view\public\header.html";i:1534387111;s:54:"F:\etereauty\application\admin\view\public\footer.html";i:1530952388;}*/ ?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="con">
                <div class="system-con">
                    <div class="main">
                        ...
                        <div class="vip-main" id="authority">
                            <div class="vip">

                                <button class="add-vip-btn">
                                    <i class="fa fa-plus"></i>添加权限节点
                                </button>
                                <div class="alertAdd-edit alert-edit-authority">
                                    <div class="ed-content">
                                        ...
                                        <div class="text">
                                            <div class="t-main">
                                                <form action="<?php echo url('admin/users/permission_add'); ?>" class="edit-form">
                                                    <ul class="t-list">
                                                        <li>
                                                            <label for="">
                                                                <span class="imp-icon">*</span>权限名称：</label>
                                                            <input type="text" class="imp" name="title">
                                                            <span class="error">请输入权限名称</span>
                                                        </li>
                                                        <li>
                                                            <label for="">
                                                                <span class="imp-icon">*</span>权限地址：</label>
                                                            <input type="text" class="imp" name="name">
                                                            <span class="error">请输入权限地址</span>
                                                        </li>
                                                        <li>
                                                            <label for="">
                                                            </label>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="vip-table-btn">
                                                ...
                                                <button class="myremove myremove-vip" ajax-url="<?php echo url('admin/users/permission_del',['id'=>$v['id']]); ?>" title="删除">
                                                    <i class="fa fa-trash-o"></i>
                                                </button>
                                            </div>
                                            <div class="alert-edit alert-edit-authority">
                                                <div class="ed-content">
                                                    <div class="ed-tit">
                                                        <span>权限节点更改</span>
                                                        <button class="ed-top-no"></button>
                                                    ...
                                                    <div class="text">
                                                        <div class="t-main">
                                                            <form action="<?php echo url('admin/users/permission_edit',['id'=>$v['id']]); ?>" class="edit-form">
                                                                <ul class="t-list">
                                                                   <li>
                                                                        <label for="">
                                                                        <span class="imp-icon">*</span>权限名称：</label>
                                                                        <input type="text" class="imp" name="title" value="<?php echo $v['title']; ?>">
                                                                        <span class="error">请输入权限名称</span>
                                                                    </li>
                                                                    <li>
                                                                        <label for="">
                                                                        <span class="imp-icon">*</span>权限地址：</label>
                                                                        <input type="text" class="imp" name="name" value="<?php echo $v['name']; ?>">
                                                                        <span class="error">请输入权限地址</span>
                                                                    </li>
                                                                    <li>
                                                                        <label for="">
                                ...
                                <div class="vip-table-operat">
                                    <div class="vip-table-allbtn">
                                        <button class="all-myremove" id="all-myremove" ajax-url="<?php echo url('admin/users/pdel_all'); ?>" >
                                            <i class="fa fa-trash-o"></i>
                                            <span>批量删除</span>
                                        </button>
                                    </div>
