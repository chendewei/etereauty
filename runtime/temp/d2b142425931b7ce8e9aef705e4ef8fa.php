<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:67:"F:\etereauty\public/../application/admin\view\users\admin_role.html";i:1534928293;s:52:"F:\etereauty\application\admin\view\public\left.html";i:1543904915;s:54:"F:\etereauty\application\admin\view\public\header.html";i:1534387111;s:54:"F:\etereauty\application\admin\view\public\footer.html";i:1530952388;}*/ ?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="con">
                <div class="system-con">
                    <div class="main">
                        ...
                        <div class="vip-main" id="role">
                            <div class="vip">

                                <button class="add-vip-btn">
                                    <i class="fa fa-plus"></i>添加角色
                                </button>
                                <div class="alertAdd-edit alert-edit-role">
                                    <div class="ed-content">
                                        ...
                                        <div class="text">
                                            <div class="t-main">
                                                <form action="<?php echo url('admin/users/admin_role_add'); ?>" class="edit-form">
                                                    <ul class="t-list">
                                                        <li>
                                                            <label for="">
                                                                <span class="imp-icon">*</span>角色名称：</label>
                                                            <input type="text" class="imp" name="roleName">
                                                            <span class="error">请输入角色名称</span>
                                                        </li>
                                                   
                                                        <li>
                                                            <label for="">网站角色：</label>
                                                            <ul class="role-http">
                                                                <li class="list">
                                                                    <div class="role-http-top">
                                                                        <input type="checkbox" name="tpf-name" class="max-all-check">
                                                                        <span class="che">全选</span>
                                                                    </div>
                                                                    <div class="role-http-con">
                                                                        <div class="role-list">
                                                                            ...
                                                                            <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v1): $mod = ($i % 2 );++$i;?>
                                                                                <div class="role-list-inp">
                                                                                    <input type="checkbox" value="<?php echo $v1['id']; ?>" name="check[]">
                                                                                    <span class="che"><?php echo $v1['title']; ?></span>
                                                                                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="vip-table-btn">
                                                ...
                                                <button class="myremove myremove-vip" ajax-url="<?php echo url('admin/users/admin_role_del',['id'=>$vo['id']]); ?>" title="删除">
                                                    <i class="fa fa-trash-o"></i>
                                                </button>
                                            </div>
                                            <div class="alert-edit alert-edit-role">
                                                <div class="ed-content">
                                                    <div class="ed-tit">
                                                        <span>编辑角色</span>
                                                        <button class="ed-top-no"></button>
                                                    ...
                                                    <div class="text">
                                                        <div class="t-main">
                                                            <form action="<?php echo url('admin/users/admin_role_edit',['id'=>$vo['id']]); ?>" class="edit-form">
                                                                <ul class="t-list">
                                                                    <li>
                                                                        <label for="">
                                                                            <span class="imp-icon">*</span>角色名称：</label>
                                                                          <input type="text" class="imp" name="roleName" value="<?php echo $vo['title']; ?>">
                                                                        <span class="error">请输入角色名称</span>
                                                                    </li>
                                                                    <li>
                                                                        <label for="">网站角色：</label>
                                                                                ...
                                                                                <div class="role-http-con">
                                                                                    <div class="role-list">
                                                                                        ...
                                                                                        <div class="role-list-right">
                                                                                            ...
                                                                                            <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v1): $mod = ($i % 2 );++$i;?>
                                                                                                <div class="role-list-inp">
                                                                                                <input type="checkbox" value="<?php echo $v1['id']; ?>" name="check[]" <?php if(in_array(($v1['id']), is_array($vo['rules'])?$vo['rules']:explode(',',$vo['rules']))): ?> checked <?php endif; ?> >
                                                                                                <span class="che"><?php echo $v1['title']; ?></span>
                                                                                                </div>
                                                                                            <?php endforeach; endif; else: echo "" ;endif; ?>
                                ...
                                <div class="vip-table-operat">
                                    <div class="vip-table-allbtn">
                                        <button class="all-myremove" id="all-myremove" ajax-url="<?php echo url('admin/users/rdel_all'); ?>" >
                                            <i class="fa fa-trash-o"></i>
                                            <span>批量删除</span>
                                        </button>
                                    </div>
