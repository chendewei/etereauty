<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:62:"F:\etereauty\public/../application/index\view\index\index.html";i:1542359547;s:54:"F:\etereauty\application\index\view\Public\header.html";i:1542607974;s:54:"F:\etereauty\application\index\view\Public\footer.html";i:1542336960;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title><?php echo $set['host_name']; ?></title>
</head>
<style>
.play-btn{
    display: none
...
<body>
    ...
    <div class="centerbox">
        ...
        <div class="container">
            ...
            <div class="title-box">
                <div class="main">
                    <h3>WHAT’S POPULAR AT ETEREAUTY</h3>
                </div>
            </div>
            <div class="video-box">
                <div class="play-btn">
                ...
                <video controls poster="/index/images/sp.jpg" id="myvideo" controls>
                <source src="/index/video/xcm.mp4" type="video/mp4">
                </video> 
            ...
            <div class="morePic">
                <div class="m-item">
                    <div class="left">
                        <a href="<?php echo $pic1['url']; ?>">
                            <img src="<?php echo $pic1['pic']; ?>" alt="">
                        </a>
                    </div>
                    <div class="right">
                        <a href="<?php echo $pic2['url']; ?>">
                            <img src="<?php echo $pic2['pic']; ?>" alt="">
                        </a>
                        <a href="<?php echo $pic3['url']; ?>">
                            <img src="<?php echo $pic3['pic']; ?>" alt="">
                        </a>
                    </div>
                    <div class="clearfix"></div>
                </div>
                <div class="m-item">
                    <div class="left">
                        <a href="<?php echo $pic4['url']; ?>">
                            <img src="<?php echo $pic4['pic']; ?>" alt="">
                        </a>
                        <a href="<?php echo $pic5['url']; ?>">
                            <img src="<?php echo $pic5['pic']; ?>" alt="">
                        </a>
                    </div>
                    <div class="right">
                        <a href="<?php echo $pic6['url']; ?>">
                            <img src="<?php echo $pic6['pic']; ?>" alt="">
                        </a>
                    </div>
                    <div class="clearfix"></div>
                </div>
