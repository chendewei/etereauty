<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:65:"F:\etereauty\public/../application/admin\view\customer\index.html";i:1534928162;s:52:"F:\etereauty\application\admin\view\public\left.html";i:1543904915;s:54:"F:\etereauty\application\admin\view\public\header.html";i:1534387111;s:54:"F:\etereauty\application\admin\view\public\footer.html";i:1530952388;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                        ...
                        <div class="vip-main" id="vipfront">
                            <div class="vip">
                                <div class="vip-search">
                                    <div>
                                    <form action="<?php echo url('customer/index'); ?>" method="get">
                                        <input type="text" name="key" class="search-text" placeholder="用户名、手机号码、邮箱">
                                ...
                                <div class="alertAdd-edit alert-edit-vip">
                                    <div class="ed-content">
                                        ...
                                        <div class="text">
                                            <div class="t-main">
                                                <form action="<?php echo url('admin/customer/add'); ?>" class="edit-form">
                                                    <ul class="t-list">
                                                        <li>
                                                            <label for="">
                                                                <span class="imp-icon">*</span>用户名：</label>
                                                            <input type="text" class="imp" name="username">
                                                            <span class="error">请输入用户名</span>
                                                        </li>
                                                        <li>
                                                            <label for="">
                                                                <span class="imp-icon">*</span>性别：</label>
                                                            <input type="radio" class="imp" name="sex" checked value="1">男
                                                            <input type="radio" class="imp" name="sex" value="2" >女
                                                           
                                                        </li>
                                                        <li>
                                                            <label for="">
                                                                <span class="imp-icon">*</span>电话：</label>
                                                             <input type="text" class="imp" name="phone">
                                                            <span class="error">请输入电话号码</span>
                                                           
                                                        </li>
                                                        <li>
                                                            <label for="">
                                                                <span class="imp-icon">*</span>邮箱：</label>
                                                            <input type="text" class="imp" name="email">
                                                            <span class="error">请输入邮箱</span>
                                                        </li>
                                                        <li>
                                                            <label for="">
                                                                <span class="imp-icon">*</span>地址：</label>
                                                            <input type="text" class="imp" name="address">
                                ...
                                <table class="vip-table">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="mystyle"><?php if($v['status'] == 1): ?>开启<?php else: ?>关闭<?php endif; ?></span>
                                        </td>
                                        <td>
                                            <div class="vip-table-btn">
                                                <button class="mystop" ajax-url="<?php echo url('admin/customer/status',['id'=>$v['id']]); ?>" title="">
                                                    <i class="fa"></i>
                                                </button>
                                                <button class="myedit myedit-vip" title="编辑">
                                                    <i class="fa fa-pencil-square-o"></i>
                                                </button>
                                                <button class="myremove myremove-vip" ajax-url="<?php echo url('admin/customer/del',['id'=>$v['id']]); ?>" title="删除">
                                            ...
                                            <div class="alert-edit alert-edit-vip">
                                                <div class="ed-content">
                                                    ...
                                                    <div class="text">
                                                        <div class="t-main">
                                                            <form action="<?php echo url('admin/customer/edit',['id'=>$v['id']]); ?>" class="edit-form">
                                                            <ul class="t-list">
                                                                <li>
                                                                <label for="">
                                                                <span class="imp-icon">*</span>用户名：</label>
                                                                <input type="text" class="imp" name="username" value="<?php echo $v['username']; ?>">
                                                                <span class="error">请输入用户名</span>
                                                                </li>
                                                                <li style="text-align: left">
                                                                <label for="">
                                                                <span class="imp-icon">*</span>性别：</label>
                                                                <input type="radio" class="imp" name="sex"  value="1" <?php if($v['sex'] == 1): ?> checked <?php endif; ?> >男
                                                                <input type="radio" class="imp" name="sex" value="2" <?php if($v['sex'] == 2): ?> checked <?php endif; ?> >女
                                                           
                                                                </li>
                                                                <li>
                                                                    <label for="">
                                                                    <span class="imp-icon">*</span>电话：</label>
                                                                    <input type="text" class="imp" name="phone" value="<?php echo $v['phone']; ?>">
                                                                    <span class="error">请输入电话号码</span>
                                                                ...
                                                                <li>
                                                                    <label for="">
                                                                    <span class="imp-icon">*</span>地址：</label>
                                                                    <input type="text" class="imp" name="address" value="<?php echo $v['address']; ?>" >
                                                                    <span class="error">请输入地址</span>
                                                                </li>
                                                                <li>
                                                                    <label for="">
                                ...
                                <div class="vip-table-operat">
                                    <div class="vip-table-allbtn">
                                        <button class="all-myremove" id="all-myremove" type="button" ajax-url="<?php echo url('admin/customer/del_all'); ?>" >
                                            <i class="fa fa-trash-o"></i>
                                            <span>批量删除</span>
                                        </button>
                                    </div>
