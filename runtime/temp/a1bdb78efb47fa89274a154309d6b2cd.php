<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:66:"F:\etereauty\public/../application/admin\view\aftersale\index.html";i:1543907466;s:52:"F:\etereauty\application\admin\view\public\left.html";i:1543904915;s:54:"F:\etereauty\application\admin\view\public\header.html";i:1534387111;s:54:"F:\etereauty\application\admin\view\public\footer.html";i:1530952388;}*/ ?>
<!DOCTYPE html>
<html lang="en">
                        ...
                        <div class="vip-main" id="vipfront">
                            <div class="vip">
                                <div class="vip-search">
                                    <div>
                                    <form action="<?php echo url('aftersale/index'); ?>" method="get">
                                        <input type="text" name="key" class="search-text" placeholder="订单号">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="vip-table-btn">
                                                ...
                                                <button style="border-radius:15px;" class="myremove myremove-vip" ajax-url="<?php echo url('aftersale/del',['id'=>$v['id']]); ?>" title="删除">
                                ...
                                <div class="vip-table-operat">
                                    <!-- <div class="vip-table-allbtn">
                                        <button class="all-myremove" id="all-myremove" ajax-url="<?php echo url('aftersale/del_all'); ?>" type="button">
                                            <i class="fa fa-trash-o"></i>
                                            <span>批量删除</span>
                                        </button>
                                    </div> -->
