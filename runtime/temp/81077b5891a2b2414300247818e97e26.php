<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:62:"F:\etereauty\public/../application/index\view\login\index.html";i:1542336558;s:54:"F:\etereauty\application\index\view\Public\header.html";i:1542607974;s:54:"F:\etereauty\application\index\view\Public\footer.html";i:1542336960;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title><?php echo $set['host_name']; ?>-Login</title>
            ...
            <div class="login">
                <div class="row">
                    <div class="img col-sm-7">
                        <img src="/index/images/login_bj.png" alt="">
                    </div>
                    <div class="text col-sm-5">
                        <h3>Please Sign In</h3>
                        <form action="<?php echo url('login/index'); ?>">
                            <div class="wrap">
                                <div class="item">
                                    <div class="tit">
                                        Email address
                                    ...
                                    <div class="inp">
                                        <input type="text" name="email" class="user_name" placeholder="Enter Your E-mail">
                                        <div class="correct">
                                ...
                                <div class="item">
                                    ...
                                    <div class="inp">
                                        <input type="password" name="password" class="pass_word" placeholder="6~15 characters in Length">
                                        <div class="correct">
                                            <i class="fa fa-check"></i>
                                        </div>
                                        <div class="error">
                                ...
                                <div class="item">
                                    <div class="checkbox">
                                        ...
                                        <span class="c-test">Remember me</span>
                                        <input class="c-inp" type="hidden" value="false" name="is_reme">
                                    </div>
                                    <div class="forget">
                                ...
                                <div class="item">
                                    <div class="my-btn account">
                                        <button type="button" onclick="window.location.href='/index/reg/index.html'" >Create account</button>
                                    </div>
                                </div>
                               <!--  <div class="item">
                                    <div class="my-btn facebook nobold">
                                        <button type="button">
                                ...
                                <div class="item">
                                    <div class="my-btn google nobold">
                                        <button type="button">
